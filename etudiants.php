                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-green-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-700"><?php echo $row['RefFil']; ?></td>
                                <td class="px-6 py-4 text-sm space-x-4">
                                    <a href="./view.php?IDEt=<?php echo $row['IDEt']; ?>" class="text-green-600 hover:text-green-800 transition-colors">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="./update.php?IDEt=<?php echo $row['IDEt']; ?>" class="text-blue-600 hover:text-blue-800 transition-colors">
                                        <i class="fas fa-pencil"></i>
                                    </a>
                                    <a href="./delete.php?IDEt=<?php echo $row['IDEt']; ?>" class="text-red-600 hover:text-red-800 transition-colors">

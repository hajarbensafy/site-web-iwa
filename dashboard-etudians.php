    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        'schedule-green': '#10b981',
                        'schedule-light': '#ecfdf5',
                    },
                    animation: {
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex space-x-6">
                    ...
                    <a href="./create_attestation.php" class="flex items-center px-4 py-2 text-gray-700 hover:text-green-600 hover:bg-green-50 rounded-lg transition-all duration-300">
        ...
        <div class="container mx-auto px-4 -mt-24 pb-12 space-y-8">
            ...
            <div class="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 overflow-hidden animate-slide-up">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr class="bg-gradient-to-r from-green-50 to-emerald-50">
                                <th class="px-6 py-4 text-left text-xs font-semibold text-green-600 uppercase tracking-wider">Jour</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-green-600 uppercase tracking-wider">Matière</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-green-600 uppercase tracking-wider">Début</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-green-600 uppercase tracking-wider">Fin</th>
                            </tr>
                        </thead>
                        <tbody id="schedule-table-body" class="bg-white divide-y divide-gray-100">
                ...
                <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-green-50 border-t border-gray-100">
                    <p class="text-sm text-gray-600">Affichage des horaires</p>
                </div>
            </div>
            ...
            <div class="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 overflow-hidden animate-slide-up">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr class="bg-gradient-to-r from-green-50 to-emerald-50">
                                <th class="px-6 py-4 text-left text-xs font-semibold text-green-600 uppercase tracking-wider">ID</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-green-600 uppercase tracking-wider">Nom</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-green-600 uppercase tracking-wider">Prénom</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-green-600 uppercase tracking-wider">Téléphone</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-green-600 uppercase tracking-wider">Email</th>
                            </tr>
                        </thead>
    ...
    <script>
        $(document).ready(function() {
            function loadTableData(tableId, url, params = {}) {
                $(`#${tableId}`).html('<tr><td colspan="5" class="px-6 py-4 text-center"><div class="inline-flex items-center"><svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-green-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>Chargement...</div></td></tr>');
